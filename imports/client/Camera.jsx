...
export default class Camera extends Component {
  ...
  getCameraAltitude(width, height) {
    ...
    return (Variables.cameraPositionAngle / 90) / (aspectRatio / (Variables.tileSize * (1070 / Variables.screenFOV)));
  }
    ...
    return (
      <Entity
        ...
        position={[
          0,
          0,
          this.props.inVR || this.props.devMode ? 0 : Variables.tileSize * 0.5 * (Variables.cameraPositionAngle / 90),
        ]}
      >
